...
public class SingletonImageProcessor {
	
	private static SingletonImageProcessor instance = null; 
	
	private SingletonImageProcessor() {}
	
	public synchronized static SingletonImageProcessor getInstance() {
		if(instance == null)
			instance = new SingletonImageProcessor(); 
		return instance; 
	}
